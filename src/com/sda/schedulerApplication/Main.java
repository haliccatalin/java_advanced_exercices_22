...
public class Main {
    ...
    /**
     * Create a class hierarchyPerson.java
     * - firstname
     * - lastname
     * - dateOfBirth
     ...
     * (How would you do that?)Ensure the fact that a group will only have a maximum of 5 students;
     * When you try to add a 6th one throw anMaximumNumberOfStudentsReached exception
     ...
     *, from all groupsDisplay all students grouped by trainer that teaches to them
     *  (eg. Trainer1 - stud1, stud3, stud4; Trainer2 - stud2, stud 10)
     *  - regardless of the group they're part of
     *  (If you were to store this information in a data structure what would you use?)
     *  Display all students with previous java knowledgeDisplay the group with the
     *  highest number of students with no previous java knowledge
